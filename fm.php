...
$CONFIG = '{"lang":"zh-CN","error_reporting":false,"show_hidden":true,"hide_Cols":false,"theme":"dark"}';
...
$auth_users = array(
    'admin' => '$2y$10$m7JT3rdrZ3nK4tKxpJ8z5.pDalU75BZH9nu82zBJkVNhLJgoC6uXm', 
    'yedi277' => '$2y$10$qmxn/UB77GHXZP.zaOkex.BBpqYUorRrZ6J0JIlCBjNgkO4fNWOeS' 
);
...
// Online office Docs Viewer - DISABLED for offline mode
...
// External CDN resources - LOCAL BUNDLED (offline mode)
$external = array(
    'css-bootstrap' => '<link href="fm/bundle.css" rel="stylesheet">',
    'css-dropzone' => '',
    'css-font-awesome' => '',
    'css-highlightjs' => '',
    'js-ace' => '<script src="fm/editor/ace.js"></script>',
    'js-bootstrap' => '',
    'js-dropzone' => '',
    'js-jquery' => '<script src="fm/bundle.js"></script>',
...
<?php
    ...
    function lng($txt)
    {
        ...
        // English Language
        $tr['zh-CN']['AppName']        = '文件管理器';
        $tr['zh-CN']['AppTitle']        = '文件管理器';
        $tr['zh-CN']['Login']        = '登录';
        ...
        $tr['zh-CN']['CalculateFolderSize']        = '显示文件夹大小';
        $tr['zh-CN']['FullSize']        = '所有文件大小';
        $tr['zh-CN']['MemoryUsed']        = '使用内存';
        $tr['zh-CN']['PartitionSize']        = '可用空间';
        $tr['zh-CN']['FreeOf']        = '磁盘大小';
        $tr['zh-CN']['Check Latest Version']        = '检查更新';
        ...
        $tr['zh-CN']['Deleted']        = '删除';
        $tr['zh-CN']['not deleted']        = '未删除';
        $tr['zh-CN']['Invalid file or folder name']        = '无效的文件或文件夹名';
        $tr['zh-CN']['Created']        = '已创建';
        $tr['zh-CN']['File extension is not allowed']        = '不允许文件扩展名';
        $tr['zh-CN']['already exists']        = '已经存在';
        $tr['zh-CN']['not created']        = '未创建';
        $tr['zh-CN']['Invalid characters in file or folder name']        = '文件或文件夹名称中的无效字符';
        $tr['zh-CN']['Source path not defined']        = '未定义源路径';
        $tr['zh-CN']['Moved from']        = '移动自';
        $tr['zh-CN']['to']        = '至';
        $tr['zh-CN']['File or folder with this path already exists']        = '具有此路径的文件或文件夹已存在';
        $tr['zh-CN']['Error while moving from']        = '移动时出错';
        $tr['zh-CN']['Copied from']        = '复制自';
        $tr['zh-CN']['Error while copying from']        = '复制时出错';
        $tr['zh-CN']['Paths must be not equal']        = '路径必须不相等';
        $tr['zh-CN']['Nothing selected']        = '未选择任何内容';
        $tr['zh-CN']['Error while renaming from']        = '重命名时出错';
        $tr['zh-CN']['Invalid characters in file name']        = '文件名中的无效字符';
        $tr['zh-CN']['Invalid Token.']        = '无效令牌。';
        $tr['zh-CN']['Selected files and folder deleted']        = '已删除选定的文件和文件夹';
        $tr['zh-CN']['Error while deleting items']        = '删除项目时出错';
        $tr['zh-CN']['Operations with archives are not available']        = '存档操作不可用';
        $tr['zh-CN']['Archive']        = '存档';
        $tr['zh-CN']['Archive not created']        = '未创建存档';
        $tr['zh-CN']['Archive unpacked']        = '存档未打包';
        $tr['zh-CN']['Archive not unpacked']        = '存档未打开';
        $tr['zh-CN']['Permissions changed']        = '权限已更改';
        $tr['zh-CN']['Permissions not changed']        = '权限未更改';
        $tr['zh-CN']['Select folder']        = '选择文件夹';
        $tr['zh-CN']['Theme']        = '主题';
        $tr['zh-CN']['light']        = '浅色';
        $tr['zh-CN']['dark']        = '深色';
        $tr['zh-CN']['Error while fetching archive info']        = '获取存档信息时出错';
        $tr['zh-CN']['File Saved Successfully']        = '文件保存成功';
        $tr['zh-CN']['FILE EXTENSION HAS NOT SUPPORTED']        = '文件扩展名不受支持';
        $tr['zh-CN']['Folder is empty']        = '文件夹为空';
        $tr['zh-CN']['Delete selected files and folders?']        = '是否删除选定的文件和文件夹？';
        $tr['zh-CN']['Create archive?']        = '创建存档？';
        $tr['zh-CN']['Zip']        = 'Zip';
        $tr['zh-CN']['Tar']        = 'Tar';
        $tr['zh-CN']['Zero byte file! Aborting download']        = '零字节文件！正在中止下载';
        $tr['zh-CN']['Cannot open file! Aborting download']        = '无法打开文件！正在中止下载';
        $tr['zh-CN']['Filter']        = '过滤器';
        $tr['zh-CN']['Advanced Search']        = '高级搜索';
        $tr['zh-CN']['Search file in folder and subfolders...']        = '在文件夹和子文件夹中搜索文件…';
        $tr['zh-CN']['Are you sure want to']        = '你确定要';
        $tr['zh-CN']['Okay']        = '确定';
        $tr['zh-CN']['a files']        = '一个文件';
        $tr['zh-CN']['Enter here...']        = '在此处输入...';
        $tr['zh-CN']['Enter new file name']        = '输入新文件名';
        $tr['zh-CN']['Full path']        = '完整路径';
        $tr['zh-CN']['File size']        = '文件大小';
        $tr['zh-CN']['MIME-type']        = 'MIME类型';
        $tr['zh-CN']['Image sizes']        = '图像大小';
        $tr['zh-CN']['Charset']        = '编码格式';
        $tr['zh-CN']['Image']        = '图片';
        $tr['zh-CN']['Audio']        = '音频';
        $tr['zh-CN']['Video']        = '视频';
        $tr['zh-CN']['Upload from URL']        = '从URL上传';
        $tr['zh-CN']['Files in archive']        = '档案文件';
        $tr['zh-CN']['Total size']        = '总大小';
        $tr['zh-CN']['Compression']        = '压缩';
        $tr['zh-CN']['Size in archive']        = '存档中的大小';
        $tr['zh-CN']['Invalid Token.']        = '无效令牌';
        $tr['zh-CN']['Fullscreen']        = '全屏';
        $tr['zh-CN']['Search']        = '搜索';
        $tr['zh-CN']['Word Wrap']        = '自动换行';
        $tr['zh-CN']['Undo']        = '撤消';
        $tr['zh-CN']['Redo']        = '恢复';
        $tr['zh-CN']['Select Document Type']        = '选择文档类型';
        $tr['zh-CN']['Select Mode']        = '选择模式';
        $tr['zh-CN']['Select Theme']        = '选择主题';
        $tr['zh-CN']['Select Font Size']        = '选择字体大小';
        $tr['zh-CN']['Are you sure want to rename?']        = '是否确实要重命名?';
